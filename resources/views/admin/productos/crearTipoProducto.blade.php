    ...
    <div class="flex flex-row">
        ...
        <section class="seccion-principal">
            ...
            <section class="contenido">
                <form action="{{route('tiposProductos.store')}}" method="POST" enctype="multipart/form-data" class="formulario">
                    @csrf
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                        ...
                        <div class="flex flex-col w-full">
                            ...
                            <input type="number" name="precio" id="precio" class="input borde-cuaternario" step="0.01" min="0">
                        </div>
                        ...
                        <div class="flex flex-row items-center gap-8 w-full">
                            ...
                            <input type="checkbox" name="estado" id="estado" value="1" class="checkbox">
                        </div>
